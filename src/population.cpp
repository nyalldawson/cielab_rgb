...
God::God()
{
  constantDist =
  {
    ...
    std::uniform_real_distribution<double>( 0.005, 0.01 ), // 0.008856
    ...
    std::uniform_real_distribution<double>( 0, 10 ), // 1
    std::uniform_real_distribution<double>( 0, 10 ), // 1
    std::uniform_real_distribution<double>( 0, 10 ), // 1

    std::uniform_real_distribution<double>( -300, 300 ), // 0
    std::uniform_real_distribution<double>( -300, 300 ), // 0
    std::uniform_real_distribution<double>( -300, 300 ), // 0
